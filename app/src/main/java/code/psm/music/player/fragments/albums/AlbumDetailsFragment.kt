 ...
 *
 */
package code.psm.music.player.fragments.albums
...
import code.psm.music.appthemehelper.common.ATHToolbarActivity.getToolbarBackgroundColor
import code.psm.music.appthemehelper.util.ToolbarContentTintHelper
import code.psm.music.player.EXTRA_ALBUM_ID
import code.psm.music.player.EXTRA_ARTIST_ID
import code.psm.music.player.EXTRA_ARTIST_NAME
import code.psm.music.player.R
import code.psm.music.player.activities.tageditor.AbsTagEditorActivity
import code.psm.music.player.activities.tageditor.AlbumTagEditorActivity
import code.psm.music.player.adapter.album.HorizontalAlbumAdapter
import code.psm.music.player.adapter.song.SimpleSongAdapter
import code.psm.music.player.databinding.FragmentAlbumDetailsBinding
import code.psm.music.player.dialogs.AddToPlaylistDialog
import code.psm.music.player.dialogs.DeleteSongsDialog
import code.psm.music.player.extensions.*
import code.psm.music.player.fragments.base.AbsMainActivityFragment
...
import code.psm.music.player.glide.SingleColorTarget
import code.psm.music.player.helper.MusicPlayerRemote
import code.psm.music.player.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_A_Z
import code.psm.music.player.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_DURATION
import code.psm.music.player.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_TRACK_LIST
import code.psm.music.player.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_Z_A
import code.psm.music.player.interfaces.IAlbumClickListener
...
import code.psm.music.player.network.Result
import code.psm.music.player.network.model.LastFmAlbum
...
import code.psm.music.player.util.RetroColorUtil
