 ...
 *
 */
package code.psm.music.player.fragments.player
...
import code.psm.music.player.SHOW_LYRICS
import code.psm.music.player.adapter.album.AlbumCoverPagerAdapter
import code.psm.music.player.adapter.album.AlbumCoverPagerAdapter.AlbumCoverFragment
import code.psm.music.player.databinding.FragmentPlayerAlbumCoverBinding
import code.psm.music.player.fragments.NowPlayingScreen.*
import code.psm.music.player.fragments.base.AbsMusicServiceFragment
...
import code.psm.music.player.model.lyrics.AbsSynchronizedLyrics
import code.psm.music.player.model.lyrics.Lyrics
import code.psm.music.player.transform.CarousalPagerTransformer
import code.psm.music.player.transform.ParallaxPagerTransformer
import code.psm.music.player.util.LyricUtil
import code.psm.music.player.util.NavigationUtil
