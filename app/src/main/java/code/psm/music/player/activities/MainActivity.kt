...
import code.psm.music.player.*
import code.psm.music.player.activities.base.AbsCastActivity
import code.psm.music.player.databinding.SlidingMusicPanelLayoutBinding
import code.psm.music.player.extensions.extra
import code.psm.music.player.extensions.findNavController
import code.psm.music.player.fragments.base.AbsRecyclerViewFragment
import code.psm.music.player.fragments.songs.SongsFragment
import code.psm.music.player.helper.MusicPlayerRemote
import code.psm.music.player.helper.SearchQueryHelper.getSongs
import code.psm.music.player.model.CategoryInfo
import code.psm.music.player.model.Song
import code.psm.music.player.repository.PlaylistSongsLoader
...
//        AppRater.appLaunched(this)
    ...
    private fun setupNavigationController() {
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            when (destination.id) {
                 R.id.action_song, R.id.action_album, R.id.action_artist, R.id.action_folder, R.id.action_playlist, R.id.action_genre -> {
                    // Save the last tab
                    if (PreferenceUtil.rememberLastTab) {
