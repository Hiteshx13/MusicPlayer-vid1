...
import code.psm.music.player.databinding.ItemPermissionBinding
import code.psm.music.player.extensions.accentOutlineColor
...
//        binding.number.backgroundTintList =attributes.getColor(R.color.color_splash)
