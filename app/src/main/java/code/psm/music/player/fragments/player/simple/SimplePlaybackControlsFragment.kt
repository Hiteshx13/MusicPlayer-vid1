 ...
 *
 */
package code.psm.music.player.fragments.player.simple
...
import code.psm.music.player.databinding.FragmentSimpleControlsFragmentBinding
...
class SimplePlaybackControlsFragment :
    ...
    private fun updateSong() {
        ...
        val value = if (PreferenceUtil.isSongInfo) {
