package code.psm.music.player.glide

import android.graphics.drawable.Drawable
import code.psm.music.appthemehelper.ThemeStore.Companion.accentColor
import code.psm.music.appthemehelper.util.TintHelper
import code.psm.music.player.App.Companion.getContext
import code.psm.music.player.Constants.USER_BANNER
import code.psm.music.player.Constants.USER_PROFILE
import code.psm.music.player.R
import code.psm.music.player.glide.artistimage.ArtistImage
import code.psm.music.player.glide.audiocover.AudioFileCover
import code.psm.music.player.glide.palette.BitmapPaletteWrapper
import code.psm.music.player.model.Artist
import code.psm.music.player.model.Song
import code.psm.music.player.util.ArtistSignatureUtil
import code.psm.music.player.util.CustomArtistImageUtil.Companion.getFile
import code.psm.music.player.util.CustomArtistImageUtil.Companion.getInstance
import code.psm.music.player.util.MusicUtil.getMediaStoreAlbumCoverUri
