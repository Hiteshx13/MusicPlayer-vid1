package code.psm.music.appthemehelper
    ...
    companion object {
        ...
        fun primaryColor(context: Context): Int {
            return prefs(context).getInt(
                ...
                resolveColor(context, R.attr.colorPrimary, Color.parseColor("#e85707"))
            )
        }
...
//            val desaturatedColor = prefs(context).getBoolean("desaturated_color", false)
            val color = prefs(context).getInt(
                ...
                resolveColor(context, R.attr.colorAccent, Color.parseColor("#C8794D"))
            )
            return color
        }
